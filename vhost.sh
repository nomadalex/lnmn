...
clear
echo "========================================================================="
echo "Add Virtual Host,  Written by ifreedom"
echo "========================================================================="
echo "This script is a tool to add virtual host for nginx "
echo "Thanks to lnmp ( http://www.lnmp.org/ )"
echo ""
echo "========================================================================="
...
if [ "$1" != "--help" ]; then
	...
	if [ "$use_nodejs" == "n"; then
	  nodejs_conf=""
	else
	  echo "Type nodejs port:"
	  read nodejs_port
	  if [ "$nodejs_port" == "" ]; then
		nodejs_port="88"
	  fi
	  echo "Your nodejs port is $nodejs_port"
	  nodejs_conf="
		location / {
...
echo "========================================================================="
echo "Add Virtual Host for LNMN V0.1  ,  Written by ifreedom "
echo "========================================================================="
echo ""
echo "Your domain:$domain"
echo "Directory of $domain:$vhostdir"
echo "Your nodejs port $port
echo ""
echo "========================================================================="
fi
